...
{else}
	<h3>Группы</h3>
	Нажмите на группе чтобы увидеть права. <br /><br />
	...
	<table width="100%" cellpadding="0" cellspacing="0">
		<tr>
			<td colspan="4">
				<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header" class="listtable">
					<tr>
						<td align="left">Группы администраторов веб</td>
		...
		<tr>
			...
			<td width="25%" height='16' class="listtable_top"><strong>Администраторы в группе</strong></td>
		    	...
		    	<td colspan="7" align="center">     	
		      	<div class="opener"> 
					<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
		          		...
		          		<tr align="left">
		            		<td width="20%" height="16" class="listtable_1">Права</td>
	...
	<tr>
		<td colspan="4">
			<table width="100%" cellpadding="0" cellspacing="0" class="front-module-header" class="listtable">
				<tr>
					<td align="left">Группы администраторов серверов</td>
			...
			<tr>	 
	    		<td colspan="7" align="center">     	
	      			<div class="opener"> 
						<table width="80%" cellspacing="0" cellpadding="0" class="listtable">
	          				<tr>
	            				<td height="16" align="left" class="listtable_top" colspan="3"><b>Сервера в этой группе</b></td>
	          				</tr>
	          				<tr align="left">
	            				<td width="20%" height="16" class="listtable_1">Имя сервера</td>
