<div>
{if $IN_SERVERS_PAGE && $access_bans}<div style="text-align:right; width:100%;"><small>Подсказка: Щёлкните правой кнопкой мыши на игроке для открытия контекстного меню с опциями кик, блокировка или отправки сообщения напрямую.</small></div>{/if}
										  ...
										  <tr>
										    ...
										    <td width="355px" class="listtable_2 opener" valign="top" style="padding-right: 0px; padding-left: 13px; padding-top: 12px;">
										    	...
										    	<div align='center'>
													...
													<input type='button' onclick="ShowBox('Reloading..','<b>Обновление данных сервера...</b><br><i>Пожалуйста подождите!</i>', 'blue', '', true);document.getElementById('dialog-control').setStyle('display', 'none');xajax_RefreshServer({$server.sid});" name='button' class='btn refresh' style='margin:0;' id='button' value='Обновить' />
										    	</div>
										    	<br />
										    </td>
										</tr>
