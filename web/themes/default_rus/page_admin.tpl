	...
	<ul>
		{if $access_admins}
			<li>
				...
				<img src="themes/default_rus/images/admin/admins.png" alt="Admin Settings" border="0" /><br />
				Admin Settings
		  		</a>
			</li>
		{/if}
		{if $access_servers}
			<li>
				...
				<img src="themes/default_rus/images/admin/servers.png" alt="Server Admin" border="0" /><br />
				Server Settings
		  		</a>
			</li>
		{/if}
		{if $access_bans}
			<li>
				...
				<img src="themes/default_rus/images/admin/bans.png" alt="Edit Bans" border="0" /><br />
				Bans
		  		</a>
			</li>
		{/if}
		{if $access_groups}
			<li>
				...
				<img src="themes/default_rus/images/admin/groups.png" alt="Edit Groups" border="0" /><br />
				Group Settings
		  		</a>
			</li>
		{/if}
		{if $access_settings}
			<li>
				...
				<img src="themes/default_rus/images/admin/settings.png" alt="SourceBans Settings" border="0" /><br />
				Webpanel Settings
		  		</a> 
			</li>
		{/if}
		{if $access_mods}
			<li>
				...
				<img src="themes/default_rus/images/admin/mods.png" alt="Mods" border="0" /><br />
				Manage Mods
		  		</a>
			</li>
		{/if}
