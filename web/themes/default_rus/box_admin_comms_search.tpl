	  	...
	  	<tr>
	  		...
	  		<div class="panel">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
						<input class="textbox" type="text" id="day" value="ДД" onmouseup="$('date').checked = true" maxlength="2" style="width: 22%;">
			            <input class="textbox" type="text" id="month" value="ММ" onmouseup="$('date').checked = true" maxlength="2" style="width: 22%;">
			            <input class="textbox" type="text" id="year" value="ГГ" onmouseup="$('date').checked = true" maxlength="4" style="width: 24%;">
					</td>
			  	</tr>
				<tr>
			        <td align="center" class="listtable_1" ><input id="length_" type="radio" name="search_type" value="radiobutton"></td>
			        <td class="listtable_1" >Продолжительность</td>
			        <td class="listtable_1" >
							...
							<tr>
								...
								<td>
									<select class="select" id="length" onmouseup="$('length_').checked = true" onchange="switch_length(this);" onmouseover="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '210px');if(this.options[this.selectedIndex].value=='other')this.focus();" onblur="if(this.options[this.selectedIndex].value=='other')$('length').setStyle('width', '20px');" style="width: 127%;">
										...
										<option value="other">Другая продолжительность в минутах</option>
									</select>
								</td>
							</tr>
						</table>
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			            <select class="select id="ban_type" onmouseup="$('ban_type_').checked = true" style="width: 95%;">
					        <option value="1" selected>Блокировка микрофона</option>
					        <option value="2">Блокировка чата</option>
						</select>
					</td>
			    </tr>
                {if !$hideadminname}
			    <tr>
			        ...
			        <td class="listtable_1" >Администратор</td>
			        <td class="listtable_1" >
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						...
						<option label="Web Ban" value="0">Веб блокировка</option>
				...
				{/if}
			    <tr>
					<td colspan="4">{sb_button text="Искать" onclick="search_blocks();" class="ok searchbtn" id="searchbtn" submit=false}</td>
			    </tr>
			   </table>
			   </div>
		  </td>
