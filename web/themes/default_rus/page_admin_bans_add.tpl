...
{else}
  <div id="msg-green" style="display:none;">
    ...
    <b>Добавление блокировки</b><br />
    Новая блокировка добавлена в систему.<br /><br />
    <i>Перенаправление обратно на страницу с блокировками</i>
  </div>
  
  <div id="add-group1">
    <h3>Добавление блокировки</h3>
    ...
    <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Ник игрока" message="Введите ник игрока кторого вы хотите заблокировать."}Ник игрока 
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Тип блокировки" message="Выберите как вы хотите заблокировать, по Steam ID или IP адресу."}Тип блокировки 
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top">
          <div class="rowdesc">
            {help_icon title="Steam ID / Community ID" message="Укажите Steam ID или Community ID блокируемого игрока."}Steam ID / Community ID
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="IP адрес" message="Введите IP адрес который вы хотите заблокировать."}IP адрес 
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Причина блокировки" message="Опишите подробно почему делается данная блокировка."}Причина блокировки 
          </div>
        </td>
        <td>
          <div align="left">
          ...
          <optgroup label="Взлом">
            <option value="Aimbot">Aimbot</option>
            <option value="Antirecoil">Нет отдачи</option>
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Продолжительность блокировки" message="Выберите продолжительность блокировки игрока."}Продолжительность блокировки 
          </div>
        </td>
        <td>
          <div align="left">
      ...
      <tr>
        <td valign="top" width="35%">
          <div class="rowdesc">
            {help_icon title="Загрузить демо" message="Нажмите здесь чтобы загрузить демо для этой блокировки."}Загрузить демо
          </div>
        </td>
        <td>
          <div align="left">
