	...
	<div id="navigation">
		...
		<div id="search">
			<form method="get" action="index.php">
				...
				<input class="searchbox" alt="Поиск блокировок" name="searchText" type="text" onfocus="this.value='';" onblur="if (this.value=='') {this.value=' Поиск блокировок...';}" value=" Поиск блокировок..." />
