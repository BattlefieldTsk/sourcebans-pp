...
define('theme_name', "SourceBans++ Default Theme - Русский язык");
 
// Set the author of this theme here
define('theme_author', "IceMan, SourceBans++ Dev Team, BattlefieldTsk");

// Set the version of the theme here
define('theme_version', "1.5.5-dev-rus");

// Set the link of the theme here
define('theme_link', "https://github.com/BattlefieldTsk/sourcebans-pp/tree/v1.x/web/themes/default_rus");
