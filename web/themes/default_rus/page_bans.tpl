...
<br />
<div id="banlist-nav"><a href="index.php?p=banlist&hideinactive={if $hidetext == 'Hide'}true{else}false{/if}{$searchlink|htmlspecialchars}" title="{$hidetext} истекшие">{$hidetext} истекшие</a> | <i>Всего блокировок: {$total_bans}</i></div>
<div id="banlist">
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
		<tr>
			...
			{/if}
			<td width="10%" height="16" class="listtable_top" align="center"><b>Продолжительность</b></td>  
		</tr>
	...
	<select name="bulk_action" id="bulk_action" onchange="BulkEdit(this,'{$admin_postkey}');">
		...
		{if $general_unban}
		<option value="U">Разблокировать</option>
		{/if}
		{if $can_delete}
	...
	{/if}
	{if $can_export }
		<a href="./exportbans.php?type=steam" title="Экспортировать постоянные блокировки по SteamID">Экспортировать постоянные блокировки по SteamID</a>&nbsp;&nbsp;|&nbsp;
		<a href="./exportbans.php?type=ip" title="Экспортировать постоянные блокировки по IP">Экспортировать постоянные блокировки по IP</a>
	{/if}
</div>
{literal}
